...
#
# Purpose:
#   Utility functions for SBOM generation, image signing, repository loading,
#   and image cleanup operations.
#
# Usage:
...
#
# Example:
#   generate_sbom "docker.io/myimage:latest"
