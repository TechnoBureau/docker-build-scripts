...
# This script downloads and installs the Instana NGINX tracing plugin.
#
# Usage: ./instana-plugin-install.sh [NGINX_TRACING_VERSION] [NGINX_VERSION]
#   - NGINX_TRACING_VERSION: The version of the Instana NGINX tracing plugin to install (default: 1.12.0)
#   - NGINX_VERSION: The version of NGINX that is being used.
